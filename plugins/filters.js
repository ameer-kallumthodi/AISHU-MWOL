...
const array = ['Hi','Bot','alive','git','AishuMwol','Haa','help','Hii','Hai','mp3','Sed','Lub','Kgf','Photo','Ayn','Andi','mp4','group','Myre','tts','Seen','Hlo','Suii','Axn4','Pm','Myr','Bgm','Da','Nop','owner','Vazha','sticker','Uyir','Chunk','Aa','Eda','Video','song','Ayshari','cyber']
array.map( async (a) => {
