...
module.exports = {
    ...
    LG_LOGO: process.env.LG_LOGO === undefined ? 'https://i.imgur.com/mJhs5Bc.jpeg' : process.env.LG_LOGO,
    LOGO_NAME: process.env.LOGO_NAME === undefined ? '𓂀 𝒜𝒾𝓈𝒽𝓊𝑀𝓌𝑜𝓁 𓂀' : process.env.LOGO_NAME,
    ...
    BOT: process.env.BOT_NAME === undefined ? '⊢‒‒‒ ⋈ ᴀɪꜱʜᴜ ᴍᴡᴏʟ ⋈ ‒‒‒⊣' : process.env.BOT_NAME,
    BOTSK: process.env.BOT_NAME === undefined ? 'ᴀɪꜱʜᴜ ᴍᴡᴏʟ' : process.env.BOT_NAME,
    LOGOSK: process.env.ALL_IMG === undefined ? 'https://telegra.ph/file/24a514f7870c10871446c.jpg' : process.env.ALL_IMG,
    ...
    ALLEMOJI: process.env.CMD_LIST === undefined ? 'AISHU MWOL/🎗️/💝/✨/📝' : process.env.CMD_LIST,
